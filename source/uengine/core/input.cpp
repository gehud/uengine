...
namespace ue {
	vector2f input::last_mouse_position = vector2f::zero();
	vector2f input::mouse_position = vector2f::zero();
	vector2f input::mouse_position_delta = vector2f::zero();
	...
	void input::update() {
		...
		mouse_position = vector2f(static_cast<float>(x), static_cast<float>(y));
